...
} elseif (isset($_SESSION['active_course_id']) && $_GET['material_id']) {
} else {
                    ...
                    <div class="col-4-xxxl col-12">
                        <div class="card height-auto">
                            <div class="card-body">
                                ...
                                <?php
                                $material = getMaterialInfo($_GET['material_id']);
                                ?>
                                <form class="new-added-form" method="POST" action="test">
                                    ...
                                    <div class="mt-3">
                                        <button type="button" onclick="updateCourseMaterial('functions/updateCourseMaterial?material_id=<?= $material['id'] ?>', getInputValuesAndReturnTheirContentAsJson(['material_title', 'material_link', 'material_writer', 'material_category', 'material_description']))" id="save_new_material_button" class="btn-fill-lg btn-gradient-yellow btn-hover-bluedark">Save</button>
