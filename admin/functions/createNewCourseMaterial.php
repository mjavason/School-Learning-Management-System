...
if (!isset($_POST)) {
    ...
    switch ($_POST) {
        case (!empty($material_title) &&
            ...
            if (createNewCourseMaterial($material_title, $material_description, $material_link, $material_writer, $material_category, $_SESSION['lecturer_id'], $_SESSION['active_course_id'],  $_SESSION['active_course_table_id'])) {
                print json_encode([['success' => 'Course Material Created!']]);
            } else {
